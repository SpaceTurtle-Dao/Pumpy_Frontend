...
<div class="bg-gray-900 text-white p-3 sm:p-4 rounded-lg">
	...
	<button class="w-full sm:w-auto bg-gray-700 px-3 py-1 rounded-md text-sm mb-3 sm:mb-0"
		>Edit profile</button
	>
	...
	<button class="mt-4 w-full sm:w-auto border border-gray-600 px-3 py-1 rounded-md text-sm"
		>Add coin</button
	>
</div>
