export const pumpy_idlFactory = ({ IDL }) => {
  ...
  const Pumpy = IDL.Service({
    ...
    'getEquivalentTokenAEstimate' : IDL.Func([PoolId, IDL.Nat], [IDL.Nat], []),
    'getEquivalentTokenBEstimate' : IDL.Func([PoolId, IDL.Nat], [IDL.Nat], []),
    'getHeapSize' : IDL.Func([], [IDL.Nat], ['query']),
    'getMemorySize' : IDL.Func([], [IDL.Nat], ['query']),
    'getShares' : IDL.Func([PoolId, IDL.Text], [IDL.Nat], ['query']),
    'getSwapTokenAEstimate' : IDL.Func([PoolId, IDL.Nat], [IDL.Nat], []),
    'getSwapTokenAEstimateGivenTokenB' : IDL.Func(
        [PoolId, IDL.Nat],
        [IDL.Nat],
        [],
      ),
    'getSwapTokenBEstimate' : IDL.Func([PoolId, IDL.Nat], [IDL.Nat], []),
