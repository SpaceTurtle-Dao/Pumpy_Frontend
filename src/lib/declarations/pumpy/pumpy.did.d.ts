...
export interface Pumpy {
  ...
  'getEquivalentTokenAEstimate' : ActorMethod<[PoolId, bigint], bigint>,
  'getEquivalentTokenBEstimate' : ActorMethod<[PoolId, bigint], bigint>,
  'getHeapSize' : ActorMethod<[], bigint>,
  'getMemorySize' : ActorMethod<[], bigint>,
  'getShares' : ActorMethod<[PoolId, string], bigint>,
  'getSwapTokenAEstimate' : ActorMethod<[PoolId, bigint], bigint>,
  'getSwapTokenAEstimateGivenTokenB' : ActorMethod<[PoolId, bigint], bigint>,
  'getSwapTokenBEstimate' : ActorMethod<[PoolId, bigint], bigint>,
  'getSwapTokenBEstimateGivenTokenA' : ActorMethod<[PoolId, bigint], bigint>,
  ...
  'price' : ActorMethod<[PoolId], bigint>,
