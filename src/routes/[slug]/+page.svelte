					...
					<div class="flex flex-row basis-1/2 gap-4">
						<div class="basis-1/2">
							...
							>
								...
								{#if analyticsData.isMarketCapUp}
									<Card.Content class="flex flex-col space-y-2">
										<Card.Title class="text-4xl">{analyticsData.marketCap}</Card.Title>
									</Card.Content>
								...
								{:else}
									...
									<Card.Footer class="gap-2">
										<ChevronDown />
										<p class="text-xs text-red-400">25%</p>
										<p class="text-xs text-muted-foreground">1hr</p>
									</Card.Footer>
								{/if}
							</Card.Root>
						...
						<div class="basis-1/2">
							...
							>
								...
								{#if analyticsData.isVolumeUp}
									<Card.Content class="flex flex-col space-y-2">
										<Card.Title class="text-4xl">{analyticsData.volume}</Card.Title>
									</Card.Content>
									<Card.Footer class="gap-2">
										<ChevronUp />
										<p class="text-xs text-green-400">25%</p>
					...
					<div class="basis-1/2">
						...
						>
							<Card.Header class="pb-2">
								...
								<Card.Title class="text-4xl">{analyticsData.liquidy}</Card.Title>
							</Card.Header>
							<Card.Content class="flex flex-col space-y-2">
